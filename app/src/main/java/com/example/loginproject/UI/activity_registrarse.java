    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tieneCuenta.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(activity_registrarse.this,loginActivity.class));
            }
        });
        mAuth = FirebaseAuth.getInstance();
        mProgressBar = new ProgressDialog(activity_registrarse.this);
        ...
        mAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                ...
                if (task.isSuccessful()) {
                    ...
                    Intent intent = new Intent(activity_registrarse.this, loginActivity.class);
